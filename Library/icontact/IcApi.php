 ...
 * 
 * @version $Id: IcApi.php 9323 2008-10-16 16:25:25Z amchardy $
 * @package IcApi
 */

/**
 * This is the class that handles most of the heavy communication logic between your
 * code and the iContact API.  It knows how to form the signature, authorizes you, etc.
 * 
...
class IcApi {
    ...
    /**
     * The login that we want to use when communicating with iContact
     *
     * @var string
     */
    private $login;
    ...
    /**
     * Forms the authorization url and requests the token from the iContact
     * server.
     *
     */
