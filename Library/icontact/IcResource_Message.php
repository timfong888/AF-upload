...
/**
 * This class represents the message resource in the iContact API.
 *
...
class IcResource_Message extends IcResource {
    ...
    public function setSendingInfo($lists, $segments=array(), $feeds=array(), $archive=true, $time="now", $category='hidden') {
        $this->what_to_get = "sending_info";
        ...
        $channels->setAttribute("category",$category);
