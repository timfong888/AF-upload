...
class SignupFinish extends QForm
{
	...
	protected function Form_Create()
	{
			...
			/* remove this for some reason getting error 
			...
			*/		
			...
			/*$this->txtOffered->CssClass="prepend-1";*/
			/*$this->txtOffered->CssClass = "Signup_input";	*/	 
			...
			$this->btnFinish->Text = QApplication::Translate('Final Step>>');
		...
		{	
			...
			if($objAccount)	
				...
				$objTarget->AccountId = $objAccount->Save();
				}
	
			$objTargetId = $objTarget->Save();	
							
		}
						
			QApplication::Redirect(__SUBDIRECTORY__ . '/signup3-addoffers.php');
