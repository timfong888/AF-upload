<?php
	...
	class Contact extends ContactGen {
		...
		public function __toString() {
			return sprintf('Contact Object %s - %s',  $this->intUserOwnerId,  $this->intOfferId);
		}
...
/*
		public static function LoadArrayBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			...
			return Contact::QueryArray(
				QQ::AndCondition(
					QQ::Equal(QQN::Contact()->Param1, $strParam1),
					QQ::GreaterThan(QQN::Contact()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
		...
		public static function LoadBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a single Contact object
		...
		public static function CountBySample($strParam1, $intParam2, $objOptionalClauses = null) {
			// This will return a count of Contact objects
			return Contact::QueryCount(
				QQ::AndCondition(
					QQ::Equal(QQN::Contact()->Param1, $strParam1),
					QQ::Equal(QQN::Contact()->Param2, $intParam2)
				),
				$objOptionalClauses
			);
		}
