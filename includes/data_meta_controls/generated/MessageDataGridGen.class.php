	...
	class MessageDataGridGen extends QDataGrid {
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'FromUserId': return QQN::Message()->FromUserId;
				case 'FromUser': return QQN::Message()->FromUser;
				case 'ToUserId': return QQN::Message()->ToUserId;
				case 'ToUser': return QQN::Message()->ToUser;
				case 'Body': return QQN::Message()->Body;
				case 'MessageTypeId': return QQN::Message()->MessageTypeId;
				case 'Id': return QQN::Message()->Id;
				case 'Subject': return QQN::Message()->Subject;
				case 'OfferId': return QQN::Message()->OfferId;
				case 'Offer': return QQN::Message()->Offer;
				case 'DateTime': return QQN::Message()->DateTime;
				case 'ContactId': return QQN::Message()->ContactId;
				case 'Contact': return QQN::Message()->Contact;
