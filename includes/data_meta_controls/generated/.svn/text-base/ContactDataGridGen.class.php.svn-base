	...
	class ContactDataGridGen extends QDataGrid {
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'OfferId': return QQN::Contact()->OfferId;
				case 'Offer': return QQN::Contact()->Offer;
				case 'Name': return QQN::Contact()->Name;
				case 'Email': return QQN::Contact()->Email;
				case 'Title': return QQN::Contact()->Title;
				case 'Phone': return QQN::Contact()->Phone;
				case 'Id': return QQN::Contact()->Id;
