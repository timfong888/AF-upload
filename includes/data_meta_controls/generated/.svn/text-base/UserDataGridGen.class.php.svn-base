<?php
	...
	class UserDataGridGen extends QDataGrid {
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = User::CountAll();
			}
			...
			$this->DataSource = User::LoadAll($objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'FullName': return QQN::User()->FullName;
				case 'Active': return QQN::User()->Active;
				case 'AccountId': return QQN::User()->AccountId;
				case 'AccountIdObject': return QQN::User()->AccountIdObject;
				case 'UserDetailId': return QQN::User()->UserDetailId;
				case 'UserDetail': return QQN::User()->UserDetail;
				case 'ManagerId': return QQN::User()->ManagerId;
				case 'ManagerIdObject': return QQN::User()->ManagerIdObject;
				case 'Code': return QQN::User()->Code;
