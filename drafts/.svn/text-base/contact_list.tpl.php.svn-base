<?php
	...
	$strPageTitle = QApplication::Translate('Contacts') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<?php $this->dtgContacts->Render(); ?>

	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/contact_edit.php"><?php _t('Create a New'); ?> <?php _t('Contact');?></a>
	</p>
