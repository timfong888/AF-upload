<?php
	...
	$strPageTitle = QApplication::Translate('Users') . ' - ' . QApplication::Translate('List All');
...
?>
	...
	<p class="create">
		<a href="<?php _p(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__) ?>/user_edit.php"><?php _t('Create a New'); ?> <?php _t('User');?></a>
	</p>
