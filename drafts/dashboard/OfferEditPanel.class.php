<?php
	...
	class OfferEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intId = null, $strControlId = null) {
			...
			$this->strTemplate = 'OfferEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the OfferMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctOffer = OfferMetaControl::Create($this, $intId);

			// Call MetaControl's methods to create qcontrols based on Offer's data fields
			$this->lblId = $this->mctOffer->lblId_Create();
			$this->lstUserOwner = $this->mctOffer->lstUserOwner_Create();
			$this->lstAccount = $this->mctOffer->lstAccount_Create();
			$this->lblTimestamp = $this->mctOffer->lblTimestamp_Create();
			...
			$this->btnDelete->AddAction(new QClickEvent(), new QConfirmAction(QApplication::Translate('Are you SURE you want to DELETE this') . ' ' . QApplication::Translate('Offer') . '?'));
