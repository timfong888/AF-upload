<?php
	 ...
	 * @subpackage Drafts
	 */
	class UserSignupCodeEditPanel extends QPanel {
		...
		public function __construct($objParentObject, $strClosePanelMethod, $intUserId = null, $intGropeCodeId = null, $strControlId = null) {
			// Call the Parent
			try {
			...
			$this->strTemplate = 'UserSignupCodeEditPanel.tpl.php';
			$this->strClosePanelMethod = $strClosePanelMethod;

			// Construct the UserSignupCodeMetaControl
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctUserSignupCode = UserSignupCodeMetaControl::Create($this, $intUserId, $intGropeCodeId);
