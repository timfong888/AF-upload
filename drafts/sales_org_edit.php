<?php
	 ...
	 * @subpackage Drafts
	 */
	class SalesOrgEditForm extends QForm {
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the SalesOrgMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctSalesOrg = SalesOrgMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/sales_org_list.php');
		}
	}

	// Go ahead and run this form object to render the page and its event handlers, implicitly using
	// sales_org_edit.tpl.php as the included HTML template file
	SalesOrgEditForm::Run('SalesOrgEditForm');
?>